# Django settings for LinSpace project.
import os
...
STATICFILES_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), 'static/img').replace('\\','/'),
...
SECRET_KEY = '_3j1+)a#$2ub@g-^84(^vw3ubi47mv6mgk=!*km1y_xfy_hvf@'
...
ROOT_URLCONF = 'LinSpace.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'LinSpace.wsgi.application'
